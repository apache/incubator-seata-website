...
class BlogDetail extends Language {
  ...
  render() {
    ...
    // 客户端页借助博客页载体
    const isClient = window.location.pathname.split('/').pop() === 'client.html';
    let currentKey = 'blog';
    if (isDownload) {
      currentKey = 'download';
    } else if (isClient) {
    ...
    return (
      <div className="blog-detail-page">
        ...
        />
        <Footer logo="https://img.alicdn.com/tfs/TB1VohYJwHqK1RjSZFgXXa7JXXa-278-72.png" language={language} />
      </div>
    );
  }
}
