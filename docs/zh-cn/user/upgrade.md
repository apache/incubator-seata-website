...
********
<h3 id='1'>Q: 1. 0.8、0.9版本如何升级到1.0版本？</h3>   
<details>
  <summary><mark>测试折叠</mark></summary>
       **A:** 
       * （可选）1.0支持yml、properties，需用seata-spring-boot-starter替换掉seata-all
       * （必选）TC端表lock_table字段branch_id增加普通索引
       * （可选）部分参数命名改动，<a href="https://seata.io/zh-cn/docs/user/configurations100.html" target="_blank">点击查看参数配置</a>
       * （可选） client.report.success.enable可以置为false，提升性能
</details>   

********

<h3 id='2'>Q: 2. 升级到 seata 1.1.0 有哪些兼容性事项是需要注意的？</h3>
