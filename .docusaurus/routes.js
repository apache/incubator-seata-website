    ...
    routes: [
      {
        ...
        component: ComponentCreator('/docs/dev/domain/overviewDomainModel', '512'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/dev/domain/rm',
        component: ComponentCreator('/docs/dev/domain/rm', '2f9'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/dev/domain/tc',
        component: ComponentCreator('/docs/dev/domain/tc', '0e3'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/dev/domain/tm',
        component: ComponentCreator('/docs/dev/domain/tm', '5e7'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/dev/mode/xa-mode', 'cd2'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/ops/deploy-by-docker-compose', '048'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/ops/deploy-guide-beginner', 'b02'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/user/apm/prometheus', 'f4b'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/apm/skywalking',
        component: ComponentCreator('/docs/user/apm/skywalking', 'e52'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/appendix/global-transaction-status',
        component: ComponentCreator('/docs/user/appendix/global-transaction-status', '334'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/appendix/isolation',
        component: ComponentCreator('/docs/user/appendix/isolation', '2a8'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/configuration/',
        component: ComponentCreator('/docs/user/configuration/', 'c4a'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/configuration/apollo',
        component: ComponentCreator('/docs/user/configuration/apollo', '54d'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/configuration/consul',
        component: ComponentCreator('/docs/user/configuration/consul', '24f'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/configuration/etcd3',
        component: ComponentCreator('/docs/user/configuration/etcd3', '0ee'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/configuration/nacos',
        component: ComponentCreator('/docs/user/configuration/nacos', '931'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/configuration/zookeeper',
        component: ComponentCreator('/docs/user/configuration/zookeeper', '2e1'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/user/datasource', '519'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/user/ormframework', '86c'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/performance',
        component: ComponentCreator('/docs/user/performance', '657'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/user/registry/', '131'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/registry/consul',
        component: ComponentCreator('/docs/user/registry/consul', '33c'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/registry/etcd3',
        component: ComponentCreator('/docs/user/registry/etcd3', '726'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/registry/eureka',
        component: ComponentCreator('/docs/user/registry/eureka', 'e18'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/registry/nacos',
        component: ComponentCreator('/docs/user/registry/nacos', 'bc8'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/registry/zookeeper',
        component: ComponentCreator('/docs/user/registry/zookeeper', '0b6'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/user/sqlreference/function', '951'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/sqlreference/sql-decoration',
        component: ComponentCreator('/docs/user/sqlreference/sql-decoration', '54a'),
        exact: true,
        sidebar: "docs"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/docs/user/txgroup/transaction-group', '824'),
        exact: true,
        sidebar: "docs"
      },
      {
        path: '/docs/user/txgroup/transaction-group-and-ha',
        component: ComponentCreator('/docs/user/txgroup/transaction-group-and-ha', '47e'),
        exact: true,
        sidebar: "docs"
      }
    ]
