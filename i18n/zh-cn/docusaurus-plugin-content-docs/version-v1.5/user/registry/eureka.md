...
在 `application.yaml` 中加入对应的配置中心,其余[配置参考](https://github.com/seata/seata/tree/1.5.0/script/client)
...
在`conf/application.yaml`中加入对应注册中心,其余[配置参考](https://github.com/seata/seata/blob/1.5.0/server/src/main/resources/application.example.yml)
