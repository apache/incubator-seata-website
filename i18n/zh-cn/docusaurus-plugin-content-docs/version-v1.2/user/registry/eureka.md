...
在 `application.yml` 中加入对应的配置中心,其余[配置参考](https://github.com/apache/incubator-seata/tree/1.2.0/script/client)
...
在 `conf/registry.conf` 中加入对应配置中心,其余[配置参考](https://github.com/apache/incubator-seata/blob/1.2.0/server/src/main/resources/file.conf.example)
