...
在 `application.yaml` 中加入对应的配置中心,其余[配置参考](https://github.com/seata/seata/tree/1.0.0/script/client)
...
在 `conf/registry.conf` 中加入对应配置中心,其余[配置参考](https://github.com/seata/seata/blob/1.0.0/server/src/main/resources/file.conf.example)
