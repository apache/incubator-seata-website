...
在 [**application.yml**](https://github.com/seata/seata/blob/1.8.0/script/client/spring/application.yml) 中加入对应的配置中心,其余[配置参考](https://github.com/seata/seata/tree/1.8.0/script/client)
...
在 [conf/application.yml](https://github.com/seata/seata/blob/1.8.0/server/src/main/resources/application.yml) 中加入对应配置中心,其余[配置参考](https://github.com/seata/seata/tree/1.8.0/script/server)
