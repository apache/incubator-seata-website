...
在 [**application.yml**](https://github.com/apache/incubator-seata/blob/1.8.0/script/client/spring/application.yml) 中加入对应的注册中心,其余[配置参考](https://github.com/apache/incubator-seata/tree/1.8.0/script/client)
