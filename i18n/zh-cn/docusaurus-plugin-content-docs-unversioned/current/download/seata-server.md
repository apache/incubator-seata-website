...
2.3.0
最新版本重磅升级！本次更新新增对Kingbase、ShenTong数据库的全面支持，集成gRPC通信协议及序列化器，大幅提升分布式事务处理能力。同时，此版本还做了大量的优化，核心优化包括：fastjson2序列化/解析提升JSON效率，Saga注解简化事务开发，Raft节点SSL通信加固安全。此版本，进一步提升了稳定性和安全性！
