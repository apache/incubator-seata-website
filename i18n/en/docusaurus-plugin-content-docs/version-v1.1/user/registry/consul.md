...
This article is based on Seata 1.1.0 and registers Seata to Consul with file as the configuration center.
...
Download [Seata 1.1.0 release](https://github.com/seata/seata/releases/tag/v1.1.0) and extract it.
