...
```
textCopy coderegister TM success. client version:1.8.0, server version:1.8.0,channel:[id: 0xa4675e28, L:/127.0.0.1:8238 - R:/127.0.0.1:8091]
...
register success, cost 94 ms, version:1.8.0,role:TMROLE,channel:[id: 0xa4675e28, L:/127.0.0.
```