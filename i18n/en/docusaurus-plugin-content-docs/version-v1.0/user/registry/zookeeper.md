...
Download [Seata 1.0.0 release](https://github.com/apache/incubator-seata/releases/tag/v1.0.0) and extract the files.
...
```
Alternatively, if you are using the `io.seata:seata-all` dependency, add the ZooKeeper configuration in the registry.conf file. For additional configurations, please refer to the [configuration reference](https://github.com/apache/incubator-seata/tree/1.0.0/script/client/conf):
```
  zk {
    serverAddr = "127.0.0.1:2181"
    session.timeout = 6000
