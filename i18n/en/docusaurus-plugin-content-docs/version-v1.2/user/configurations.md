...
| store.db.user                                                                                                                                                                                                |                                            |
| store.db.password                                                                                                                                                                                            |                                            |
| #store.mode=Redis requires the following configurations,The storage structure of Redis in version 1.2 has been refactored in version 1.3, so it is not recommended to use Redis storage mode in version 1.2. |                                            |
| store.redis.host                                                                                                                                                                                             |                                            |
| store.redis.port                                                                                                                                                                                             |                                            |
...
| transport.compressor                      | Compression method of communication data between client and server                    | none, gzip, zip, default none                                                                                                                                                                                                                                                                                                                                                                                                             |               |
...
| store.redis.host                           | redis mode IP                                                                                                                   | Default 127.0.0.1                                                                                                                                                                                                                                                                                                                                                                                          |               |
| store.redis.port                           | redis mode port                                                                                                                 | 6379 by default                                                                                                                                                                                                                                                                                                                                                                                            |               |
