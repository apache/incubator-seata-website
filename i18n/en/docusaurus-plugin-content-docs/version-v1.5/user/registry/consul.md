...
This article is based on Seata 1.5.0 and registers Seata to Consul with file as the configuration center.
...
Download [Seata 1.5.0 release](https://github.com/seata/seata/releases/tag/v1.5.0) and extract it.
...
seata:
  registry:
    consul:
      server-addr: 127.0.0.1:8500
  # Transaction group configuration, default name is my_test_tx_group in version 1.5.0, will be changed to default_tx_group in version 1.5
...
```text
register TM success. client version:1.5.0, server version:1.5.0,channel:[id: 0xa4675e28, L:/127.0.0.1:8238 - R:/127.0.0.1:8091]
register RM success. client version:1.5.0, server version:1.5.0,channel:[id: 0x408192d3, L:/127.0.0.1:8237 - R:/127.0.0.1:8091]
register success, cost 94 ms, version:1.5.0,role:RMROLE,channel:[id: 0x408192d3, L:/127.0.0.1:8237 - R:/127.0.0.1:8091]
register success, cost 94 ms, version:1.5.0,role:TMROLE,channel:[id: 0xa4675e28, L:/127.0.0.1:8238 - R:/127.0.0.1:8091]
```
