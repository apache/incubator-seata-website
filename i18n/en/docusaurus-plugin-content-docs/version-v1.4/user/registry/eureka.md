...
Add the corresponding configuration to [**application.yml**](https://github.com/apache/incubator-seata/blob/1.4.2/script/client/spring/application.yml), and refer to the [Configuration Reference](https://github.com/apache/incubator-seata/tree/1.4.2/script/client) for other configurations.
...
Add the corresponding configuration center in [registry.conf](https://github.com/apache/incubator-seata/blob/1.4.2/server/src/main/resources/registry.conf), and refer to the [configuration](https://github.com/apache/incubator-seata/tree/1.4.2/script/server) for the rest.
