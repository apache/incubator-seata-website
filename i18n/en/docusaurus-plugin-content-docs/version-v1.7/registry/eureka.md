...
Add the corresponding configuration to [**application.yml**](https://github.com/seata/seata/blob/1.7.0/script/client/spring/application.yml), and refer to the [Configuration Reference](https://github.com/seata/seata/tree/1.7.0/script/client) for other configurations.
...
Add the corresponding configuration center in [conf/application.yml](https://github.com/seata/seata/blob/1.7.0/server/src/main/resources/application.yml), and refer to the [configuration](https://github.com/seata/seata/blob/1.7.0/server/src/main/resources/application.example.yml) for the rest.
