...
This article is based on Seata 2.0.0 and registers Seata to Consul with file as the configuration center.
...
Download [Seata 2.0.0 release](https://github.com/seata/seata/releases/tag/v2.0.0) and extract it.
...
seata:
  registry:
    consul:
      server-addr: 127.0.0.1:8500
  # Transaction group configuration, default name is my_test_tx_group in version 2.0.0, will be changed to default_tx_group in version 1.5
